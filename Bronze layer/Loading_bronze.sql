...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'E:\ITI Data Engineering\data visulatization project\train\df_Customers.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'E:\ITI Data Engineering\data visulatization project\train\df_Products.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'E:\ITI Data Engineering\data visulatization project\train\Data source CSV\df_Products.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Table: bronze.payment';
		TRUNCATE TABLE bronze.payment;
		PRINT '>> Inserting Data Into: bronze.payment';
		BULK INSERT bronze.payment
		FROM 'E:\ITI Data Engineering\data visulatization project\train\Data source CSV\df_Payments.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK
